...
var createNewTaskElement=function(taskString){
    ...
    checkBox.classList = "task-list__input task-list__input_checkbox";
    editInput.type="text";
    editInput.className="task task-list__input task-list__input_text";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.task-list__input_text');
...
//select ListItems children
    var checkBox=taskListItem.querySelector("input.task-list__input_checkbox");
